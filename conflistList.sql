INSERT INTO conflicts (id, name, location, background, dead, displaced, duration, status) VALUES (1, "Criminal Violence in Mexico", "Mexico", "Increased gang and cartel violence associated with territorial drug trafficking.", "150,000", "~20,000 presently", "30+ years", "Unchanging");
INSERT INTO conflicts (id, name, location, background, dead, displaced, duration, status) VALUES (2, "Instability in Venezuela", "Venezuela", "Economic mismanagement, corruption, and an over-reliance on oil exports lead to an unprecedented economic collapse.", "Unknown", "3.4 million", "~6 years", "Worsening");
INSERT INTO conflicts (id, name, location, background, dead, displaced, duration, status) VALUES (3, "Destabilization of Mali", "Mali", "Transnational terrorist groups continuously assert territorial claims and destabilize the government.", "Estimated thousands", "325,500", "60 years, since gaining independence in 1960", "Worsening");
INSERT INTO conflicts (id, name, location, background, dead, displaced, duration, status) VALUES (4, "Boko Haram", "Nigeria", "Boko Haram,a large Islamist militant group, continues to conduct terrorist attacks on religious and political groups, as well as indiscriminately attack civilians.", "38,000", "2.5 million", "9 years", "Unchanging");
INSERT INTO conflicts (id, name, location, background, dead, displaced, duration, status) VALUES (5, "Violence in the Central African Republic", "Central African Republic", "Decades of  violence, instability and terrorism plague the country following independence.", "Estimated thousands", "580,000", "60 years, since gaining independence in 1960", "Unchanging");
INSERT INTO conflicts (id, name, location, background, dead, displaced, duration, status) VALUES (6, "Violence in the Democratic Republic of the Congo", "Democratic Republic of the Congo", "Continuing violence following the refugee crisis and spillover from the 1994 genocide in Rwanda.", "Estimates vary, as many as 3 million", "4.5 million", "26 years", "Unchanging");
INSERT INTO conflicts (id, name, location, background, dead, displaced, duration, status) VALUES (7, "Civil War in South Sudan", "South Sudan", "A political struggle for supremacy erupted into civil war along ethnic lines.", "400,000", "2.24 million", "7 years", "Unchanging");
INSERT INTO conflicts (id, name, location, background, dead, displaced, duration, status) VALUES (8, "Al-Shabab", "Somalia", "Terrorist group Al-Shabab capitalizes on the weak Somali government to control large swaths of territory.", "4,200", "35,000", "14 years", "Unchanging");
INSERT INTO conflicts (id, name, location, background, dead, displaced, duration, status) VALUES (9, "Civil War in Libya", "Libya", "Continuous challenges since the ousting of former leader Muammar al-Qaddafi has lead to on-going civil war.", "Estimated thousands", "300,000", "9 years", "Unchanging");
INSERT INTO conflicts (id, name, location, background, dead, displaced, duration, status) VALUES (10, "Instability in Egypt", "Egypt", "Political instability, terrorism, and police brutality combined to create on-going unrest.", "Estimated thousands", "Estimated thousands", "9 years", "Unchanging");
INSERT INTO conflicts (id, name, location, background, dead, displaced, duration, status) VALUES (11, "Conflict in Ukraine", "Ukraine", "Territorial disputes with Russia and internal unrest continue to ebb and flow.", "10,000", "1.5 million", "6 years", "Unchanging");
INSERT INTO conflicts (id, name, location, background, dead, displaced, duration, status) VALUES (12, "Nagorno-Karabakh Conflict", "Armenia", "Territorial disputes between Azerbaijan and Armenia remain violent following the dissolution of the USSR.", "Thousands", "Estimates vary widely, as many as 2 million total", "29 years", "Unchanging");
INSERT INTO conflicts (id, name, location, background, dead, displaced, duration, status) VALUES (13, "Political Instability in Lebanon", "Lebanon", "On-going violence and unrest caused by political instability, ethnic and religious disputes, and foreign interference.", "Thousands", "~1.5 million presently", "Varying levels of violence and unrest since 1975", "Unchanging");
INSERT INTO conflicts (id, name, location, background, dead, displaced, duration, status) VALUES (14, "Turkish Territorial Dispute", "Turkey", "On-going conflict between Turkey and armed Kurdish groups seeking independence.", "40,000", "~3 million total", "42 years", "Unchanging");
INSERT INTO conflicts (id, name, location, background, dead, displaced, duration, status) VALUES (15, "Israeli-Palestinian Conflict", "Israel", "Centuries long territorial conflict over the Gaza Strip continues in violence today.", "Unknown", "Millions in total", "200 years", "Unchanging");
INSERT INTO conflicts (id, name, location, background, dead, displaced, duration, status) VALUES (16, "Civil War in Syria", "Syria", "What began as protests again President Assad's regime erupted into full-scale civil war between the government and rebel groups"., "400,000", "11.8 million", "9 years", "Unchanging");
INSERT INTO conflicts (id, name, location, background, dead, displaced, duration, status) VALUES (17, "Political Instability in Iraq", "Iraq", "The US and nearly 80 other countries have formed a coalition aimed at eliminating the Islamic State, which seeks to control Iraq.", "Estimated 185,000", "2 million", "6 years", "Unchanging");
INSERT INTO conflicts (id, name, location, background, dead, displaced, duration, status) VALUES (18, "Civil War in Yemen", "Yemen", "Now considered the world's worst humanitarian crisis, the civil war rages between Houthi rebels and the Yemeni government.", "100,000", "4 million", "6 years", "Worsening");
INSERT INTO conflicts (id, name, location, background, dead, displaced, duration, status) VALUES (19, "Iranian-US Conflict", "Iran", "Complex and on-going tensions between the US and Iran on varying subjects including nuclear programs, oil, and terrorism.", "Unknown", "Unknown", "41 years", "Worsening");
INSERT INTO conflicts (id, name, location, background, dead, displaced, duration, status) VALUES (20, "War in Afghanistan", "Afghanistan", "Following 9/11, the US has been fighting various terrorist organizations while also trying to rebuild a strong central government in Afghanistan.", "100,000 civilians", "~1.5 million", "19 years", "Worsening");
INSERT INTO conflicts (id, name, location, background, dead, displaced, duration, status) VALUES (21, "Islamist Militancy in Pakistan", "Pakistan", "Pakistan continues to face significant threats to its internal security due to the Taliban and other militant groups.", "Estimated thousands", "Estimated thousands", "6 years", "Unchanging");
INSERT INTO conflicts (id, name, location, background, dead, displaced, duration, status) VALUES (22, "Conflict in Kashmir", "India", "Territorial disputes between Pakistan and India over the Kashmir border region continue with violence and unrest.", "40,000 since 1989", "Estimated hundreds of thousands", "Varying levels of violence since 1947", "Worsening");
INSERT INTO conflicts (id, name, location, background, dead, displaced, duration, status) VALUES (23, "Territorial Disputes in the South China Sea", "China", "China's sweeping claims of sovereignty over the South China Sea and it's resources continues to raise tensions globally.", null, null, "Territorial disputes began arising as early as 1951", "Worsening");
INSERT INTO conflicts (id, name, location, background, dead, displaced, duration, status) VALUES (24, "Tensions in the East China Sea", "China", "China has begun asserting territorial claims over economically significant islands owned by Japan in the East China Sea.", null, null, "8 years, although tensions date back to the 1970s", "Unchanging");
INSERT INTO conflicts (id, name, location, background, dead, displaced, duration, status) VALUES (25, "North Korea Crisis", "North Korea", "North Korea is a volatile, impoverished, and isolated dictatorship.", "Unknown", "None", "67 years", "Worsening");
INSERT INTO conflicts (id, name, location, background, dead, displaced, duration, status) VALUES (26, "Rohingya Crisis", "Myanmar", "The Rohingya people of Myanmar face systematic discrimination, statelessness, and violence in what some groups condemn as a genocide.", "24,000", "~140,000", "3 years, although tensions date back decades", "Unchanging");
...
INSERT INTO countries (id, country, region) VALUES (28, "Armenia", "Europe");
INSERT INTO countries (id, country, region) VALUES (29, "Azerbaijan", "Europe");
...
INSERT INTO countries_involved (conflict_id, country_id) VALUES (12, 28);
INSERT INTO countries_involved (conflict_id, country_id) VALUES (12, 29);
