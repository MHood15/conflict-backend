...
INSERT INTO conflicts (id, name, location, background, dead, displaced, duration, status, image) VALUES (2, "Instability in Venezuela", "Venezuela", "Economic mismanagement, corruption, and an over-reliance on oil exports lead to an unprecedented economic collapse.", "Unknown", "3.4 million", "~6 years", "Worsening", "https://lh3.googleusercontent.com/proxy/GoVQXwuZtg2Nu2gf5yV92d793EmD-87HOlZTb8taEmx6tAgSWHst4FuCHm4o__ZmFLebr_RNoGT8X_beEVqgr6dj3QotmGVDYGKgNqPI5FRKNysz_Q");
INSERT INTO conflicts (id, name, location, background, dead, displaced, duration, status, image) VALUES (3, "Destabilization of Mali", "Mali", "Transnational terrorist groups continuously assert territorial claims and destabilize the government.", "Estimated thousands", "325,500", "60 years, since gaining independence in 1960", "Worsening", "https://lh3.googleusercontent.com/proxy/miAgw0FvY-tVF7DUWee75eS9afj-utcvYtuqjI4mriQ15sx2jFGAckz9Bq9LjLO-CyvvHv7dNVpHP00ygnew3sKJABTTKFUbjovhYOtXHjzFbPqZCTcEtkUtazMsqg");
